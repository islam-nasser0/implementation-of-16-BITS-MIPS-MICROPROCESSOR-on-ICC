...
import_designs  /home/ahesham/Desktop/Teaching/islam/syn/output/${design}.v \
                -format verilog \
		-top ${design} \
		-cel ${design}


source  /home/ahesham/Desktop/Teaching/islam/syn/cons/cons.tcl
...
#### insert power rings and strips ([10,9,8,7] as metal layers ,6[as strips only] )
commit_fp_rail
##### add routing layers (5,4,3,2,1)
###make gouting from metal_layer1 to metal_layer6 as a tapping layer
...
## Add Well Tie Cells (prevent latchup proplem)
#####################
